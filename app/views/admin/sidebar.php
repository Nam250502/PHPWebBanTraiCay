<aside class="left-sidebar ">
    <div>
        <div class="container d-flex align-items-end justify-content-center">
            <span></span>
            <div class="brand-logo rounded-circle overflow-hidden p-1 bg-light w-50 ">
                <img src="https://t3.ftcdn.net/jpg/03/74/73/78/360_F_374737839_VsxlmnN7soqOOOFFzy5kfE9H6PFMCkPX.jpg"
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="/chieu2/admin/listProducts" aria-expanded="false">
                        <span>
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="/chieu2/product/add" aria-expanded="false">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="/chieu2/category/listCategorys" aria-expanded="false">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <div>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="/chieu2/order/list" aria-expanded="false">
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="/chieu2/order/showReport" aria-expanded="false">
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="/chieu2/review/listReviews" aria-expanded="false">
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
